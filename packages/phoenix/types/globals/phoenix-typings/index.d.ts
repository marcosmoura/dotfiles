...
// Source: https://raw.githubusercontent.com/mafredri/phoenix-typings/master/index.d.ts
interface Error {
  line: number
  column: number
}
...
interface EventObject {
  ...
  new (event: Phoenix.MouseEvent, callback: (target: MousePoint, handler: Event) => void): Event
  ...
  on(event: Phoenix.MouseEvent, callback: (target: MousePoint, handler: Event) => void): number
...
declare namespace Phoenix {
  ...
  type ModifierKey = 'command' | 'cmd' | 'option' | 'alt' | 'control' | 'ctrl' | 'shift'
