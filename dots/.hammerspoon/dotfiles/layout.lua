...
function setupManualWindows (windowLayout)
  ...
  setupTilingWindow(windowLayout, 'Calendar', 880, 38, 1024, 978)
  setupTilingWindow(windowLayout, 'Paymo Widget', 16, 38, 600, 978)
  setupTilingWindow(windowLayout, 'Notion', 632, 38, 1272, 978)
  setupTilingWindow(windowLayout, 'Agenda', 632, 38, 1272, 978)
  setupTilingWindow(windowLayout, 'Things', 632, 38, 1272, 978)
end
